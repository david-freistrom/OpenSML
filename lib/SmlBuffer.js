...
SmlBuffer.prototype.readOctetString = function readOctetString(){	
	...
	if(tlField.type!=0x08 && tlField.type!=0x00){
		throw new Error("Unknown TL-Field for OctetString [Offset: "+this.offset+"]!");
	}
...
SmlBuffer.prototype.readSmlValue = function readSmlValue(value){	
	if((this.buffer.readUInt8(this.offset)>>4)==0x00){
