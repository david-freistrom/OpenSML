...
SmlCRC.crc16CCITT = function crc16CCITT(buffer) {
    /*
     * table to calculate crc16
     */
    var table = [ 0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf, 0x8c48, 0x9dc1,
...
/*
 * Some smart meters (e.g. EHz) rortate the result of CRC16 too, so we use both ways when comparing
 */
SmlCRC.crc16CCITTRotate = function crc16CCITTRotate(buffer) {
    var crc = this.crc16CCITT(buffer);
    crc = ((crc & 0xff) << 8) | ((crc & 0xff00) >> 8);
    return crc;
};

module.exports = SmlCRC;
